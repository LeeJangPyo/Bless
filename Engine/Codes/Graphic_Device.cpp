...
_USING(Engine)
_IMPLEMENT_SINGLETON(Engine::CGraphic_Device)
...
HRESULT Engine::CGraphic_Device::Ready_Graphic_Device(WINMODE Mode, HWND hWnd, const WORD& wSizeX, const WORD& wSizeY, LPDIRECT3DDEVICE9* ppGraphic_Device)
{
	...
	{
		_MSG_BOX(L"GetDeviceCaps Failed");
		return E_FAIL;
	}
	...
	{
		_MSG_BOX(L"CreateDevice Failed");
		return E_FAIL;
	}
...
void Engine::CGraphic_Device::SetParameters(D3DPRESENT_PARAMETERS& d3dpp, WINMODE Mode, HWND hWnd, const WORD& wSizeX, const WORD& wSizeY)
{
