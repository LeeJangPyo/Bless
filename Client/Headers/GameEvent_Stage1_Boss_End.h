#ifndef GameEvent_Stage1_Boss_End_h__
#define GameEvent_Stage1_Boss_End_h__
...
class CGameEvent_Stage1_Boss_End final : public CGameEvent
{
public:
	explicit CGameEvent_Stage1_Boss_End();
	virtual ~CGameEvent_Stage1_Boss_End() = default;
...
#endif // GameEvent_Stage1_Boss_End_h__