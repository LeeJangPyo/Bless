#ifndef Sire_Spell_Target_h__
#define Sire_Spell_Target_h__
...
class CSire;
class CEffectGroup;
class CSire_Meteo_Target : public CState
{
private:
	explicit CSire_Meteo_Target();
	virtual ~CSire_Meteo_Target() = default;
...
public:
	static CSire_Meteo_Target*	Create(CSire* pSire);
protected:
