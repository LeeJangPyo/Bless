...
#ifndef GameEvent_Stage1_Combat_h__
#define GameEvent_Stage1_Combat_h__
...
class CGameEvent_Stage1_Combat final :public CGameEvent
{
public:
	explicit CGameEvent_Stage1_Combat();
	virtual ~CGameEvent_Stage1_Combat() = default;
...
#endif // GameEvent_Stage1_Combat_h__